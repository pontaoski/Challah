...
class FetchLinkMetadataResponse;
class FetchLinkMetadataResponseDefaultTypeInternal;
extern FetchLinkMetadataResponseDefaultTypeInternal _FetchLinkMetadataResponse_default_instance_;
...
template<> ::protocol::mediaproxy::v1::FetchLinkMetadataResponse* Arena::CreateMaybeMessage<::protocol::mediaproxy::v1::FetchLinkMetadataResponse>(Arena*);
...
template<> ::protocol::mediaproxy::v1::MediaMetadata* Arena::CreateMaybeMessage<::protocol::mediaproxy::v1::MediaMetadata>(Arena*);
...
class MediaMetadata PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.mediaproxy.v1.MediaMetadata) */ {
 public:
  inline MediaMetadata() : MediaMetadata(nullptr) {};
  ...
  inline void Swap(MediaMetadata* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(MediaMetadata* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  MediaMetadata* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.mediaproxy.v1.MediaMetadata";
  }
  protected:
  explicit MediaMetadata(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:protocol.mediaproxy.v1.MediaMetadata)
 private:
  class _Internal;
...
class FetchLinkMetadataResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.mediaproxy.v1.FetchLinkMetadataResponse) */ {
 public:
  inline FetchLinkMetadataResponse() : FetchLinkMetadataResponse(nullptr) {};
  virtual ~FetchLinkMetadataResponse();

  FetchLinkMetadataResponse(const FetchLinkMetadataResponse& from);
  FetchLinkMetadataResponse(FetchLinkMetadataResponse&& from) noexcept
    : FetchLinkMetadataResponse() {
    *this = ::std::move(from);
  }

  inline FetchLinkMetadataResponse& operator=(const FetchLinkMetadataResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline FetchLinkMetadataResponse& operator=(FetchLinkMetadataResponse&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const FetchLinkMetadataResponse& default_instance();
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const FetchLinkMetadataResponse* internal_default_instance() {
    return reinterpret_cast<const FetchLinkMetadataResponse*>(
               &_FetchLinkMetadataResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(FetchLinkMetadataResponse& a, FetchLinkMetadataResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(FetchLinkMetadataResponse* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(FetchLinkMetadataResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline FetchLinkMetadataResponse* New() const final {
    return CreateMaybeMessage<FetchLinkMetadataResponse>(nullptr);
  }

  FetchLinkMetadataResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<FetchLinkMetadataResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const FetchLinkMetadataResponse& from);
  void MergeFrom(const FetchLinkMetadataResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(FetchLinkMetadataResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.mediaproxy.v1.FetchLinkMetadataResponse";
  }
  protected:
  explicit FetchLinkMetadataResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kIsSiteFieldNumber = 1,
    kIsMediaFieldNumber = 2,
  };
  // .protocol.mediaproxy.v1.SiteMetadata is_site = 1;
  bool has_is_site() const;
  private:
  bool _internal_has_is_site() const;
  public:
  void clear_is_site();
  const ::protocol::mediaproxy::v1::SiteMetadata& is_site() const;
  ::protocol::mediaproxy::v1::SiteMetadata* release_is_site();
  ::protocol::mediaproxy::v1::SiteMetadata* mutable_is_site();
  void set_allocated_is_site(::protocol::mediaproxy::v1::SiteMetadata* is_site);
  private:
  const ::protocol::mediaproxy::v1::SiteMetadata& _internal_is_site() const;
  ::protocol::mediaproxy::v1::SiteMetadata* _internal_mutable_is_site();
  public:
  void unsafe_arena_set_allocated_is_site(
      ::protocol::mediaproxy::v1::SiteMetadata* is_site);
  ::protocol::mediaproxy::v1::SiteMetadata* unsafe_arena_release_is_site();

  // .protocol.mediaproxy.v1.MediaMetadata is_media = 2;
  bool has_is_media() const;
  private:
  bool _internal_has_is_media() const;
  public:
  void clear_is_media();
  const ::protocol::mediaproxy::v1::MediaMetadata& is_media() const;
  ::protocol::mediaproxy::v1::MediaMetadata* release_is_media();
  ::protocol::mediaproxy::v1::MediaMetadata* mutable_is_media();
  void set_allocated_is_media(::protocol::mediaproxy::v1::MediaMetadata* is_media);
  private:
  const ::protocol::mediaproxy::v1::MediaMetadata& _internal_is_media() const;
  ::protocol::mediaproxy::v1::MediaMetadata* _internal_mutable_is_media();
  public:
  void unsafe_arena_set_allocated_is_media(
      ::protocol::mediaproxy::v1::MediaMetadata* is_media);
  ::protocol::mediaproxy::v1::MediaMetadata* unsafe_arena_release_is_media();

  void clear_data();
  DataCase data_case() const;
  // @@protoc_insertion_point(class_scope:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
 private:
  class _Internal;
  void set_has_is_site();
  void set_has_is_media();
  ...
  union DataUnion {
    DataUnion() {}
    ::protocol::mediaproxy::v1::SiteMetadata* is_site_;
    ::protocol::mediaproxy::v1::MediaMetadata* is_media_;
  } data_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// string mimetype = 1;
inline void MediaMetadata::clear_mimetype() {
  mimetype_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& MediaMetadata::mimetype() const {
  // @@protoc_insertion_point(field_get:protocol.mediaproxy.v1.MediaMetadata.mimetype)
  return _internal_mimetype();
}
inline void MediaMetadata::set_mimetype(const std::string& value) {
  _internal_set_mimetype(value);
  // @@protoc_insertion_point(field_set:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}
inline std::string* MediaMetadata::mutable_mimetype() {
  // @@protoc_insertion_point(field_mutable:protocol.mediaproxy.v1.MediaMetadata.mimetype)
  return _internal_mutable_mimetype();
}
inline const std::string& MediaMetadata::_internal_mimetype() const {
  return mimetype_.Get();
}
inline void MediaMetadata::_internal_set_mimetype(const std::string& value) {
  
  mimetype_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void MediaMetadata::set_mimetype(std::string&& value) {
  
  mimetype_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}
inline void MediaMetadata::set_mimetype(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  mimetype_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}
inline void MediaMetadata::set_mimetype(const char* value,
    size_t size) {
  ...
  mimetype_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}
inline std::string* MediaMetadata::_internal_mutable_mimetype() {
  
  return mimetype_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* MediaMetadata::release_mimetype() {
  // @@protoc_insertion_point(field_release:protocol.mediaproxy.v1.MediaMetadata.mimetype)
  return mimetype_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void MediaMetadata::set_allocated_mimetype(std::string* mimetype) {
  if (mimetype != nullptr) {
  ...
  mimetype_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), mimetype,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}
inline std::string* MediaMetadata::unsafe_arena_release_mimetype() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protocol.mediaproxy.v1.MediaMetadata.mimetype)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return mimetype_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MediaMetadata::unsafe_arena_set_allocated_mimetype(
    std::string* mimetype) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (mimetype != nullptr) {
  ...
  mimetype_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      mimetype, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protocol.mediaproxy.v1.MediaMetadata.mimetype)
}

// string filename = 2;
inline void MediaMetadata::clear_filename() {
  filename_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& MediaMetadata::filename() const {
  // @@protoc_insertion_point(field_get:protocol.mediaproxy.v1.MediaMetadata.filename)
  return _internal_filename();
}
inline void MediaMetadata::set_filename(const std::string& value) {
  _internal_set_filename(value);
  // @@protoc_insertion_point(field_set:protocol.mediaproxy.v1.MediaMetadata.filename)
}
inline std::string* MediaMetadata::mutable_filename() {
  // @@protoc_insertion_point(field_mutable:protocol.mediaproxy.v1.MediaMetadata.filename)
  return _internal_mutable_filename();
}
inline const std::string& MediaMetadata::_internal_filename() const {
  return filename_.Get();
}
inline void MediaMetadata::_internal_set_filename(const std::string& value) {
  
  filename_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void MediaMetadata::set_filename(std::string&& value) {
  
  filename_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:protocol.mediaproxy.v1.MediaMetadata.filename)
}
inline void MediaMetadata::set_filename(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  filename_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:protocol.mediaproxy.v1.MediaMetadata.filename)
}
inline void MediaMetadata::set_filename(const char* value,
    size_t size) {
  ...
  filename_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:protocol.mediaproxy.v1.MediaMetadata.filename)
}
inline std::string* MediaMetadata::_internal_mutable_filename() {
  
  return filename_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* MediaMetadata::release_filename() {
  // @@protoc_insertion_point(field_release:protocol.mediaproxy.v1.MediaMetadata.filename)
  return filename_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void MediaMetadata::set_allocated_filename(std::string* filename) {
  if (filename != nullptr) {
  ...
  filename_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), filename,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:protocol.mediaproxy.v1.MediaMetadata.filename)
}
inline std::string* MediaMetadata::unsafe_arena_release_filename() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protocol.mediaproxy.v1.MediaMetadata.filename)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return filename_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void MediaMetadata::unsafe_arena_set_allocated_filename(
    std::string* filename) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (filename != nullptr) {
  ...
  filename_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      filename, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protocol.mediaproxy.v1.MediaMetadata.filename)
}
...
// .protocol.mediaproxy.v1.SiteMetadata is_site = 1;
inline bool FetchLinkMetadataResponse::_internal_has_is_site() const {
  return data_case() == kIsSite;
}
inline bool FetchLinkMetadataResponse::has_is_site() const {
  return _internal_has_is_site();
}
inline void FetchLinkMetadataResponse::set_has_is_site() {
  _oneof_case_[0] = kIsSite;
}
inline void FetchLinkMetadataResponse::clear_is_site() {
...
inline ::protocol::mediaproxy::v1::SiteMetadata* FetchLinkMetadataResponse::release_is_site() {
  // @@protoc_insertion_point(field_release:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
  if (_internal_has_is_site()) {
    clear_has_data();
      ::protocol::mediaproxy::v1::SiteMetadata* temp = data_.is_site_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.is_site_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::protocol::mediaproxy::v1::SiteMetadata& FetchLinkMetadataResponse::_internal_is_site() const {
  return _internal_has_is_site()
      ? *data_.is_site_
      : *reinterpret_cast< ::protocol::mediaproxy::v1::SiteMetadata*>(&::protocol::mediaproxy::v1::_SiteMetadata_default_instance_);
}
inline const ::protocol::mediaproxy::v1::SiteMetadata& FetchLinkMetadataResponse::is_site() const {
  // @@protoc_insertion_point(field_get:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
  return _internal_is_site();
}
inline ::protocol::mediaproxy::v1::SiteMetadata* FetchLinkMetadataResponse::unsafe_arena_release_is_site() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
  if (_internal_has_is_site()) {
    clear_has_data();
    ::protocol::mediaproxy::v1::SiteMetadata* temp = data_.is_site_;
    data_.is_site_ = nullptr;
...
inline void FetchLinkMetadataResponse::unsafe_arena_set_allocated_is_site(::protocol::mediaproxy::v1::SiteMetadata* is_site) {
  clear_data();
  if (is_site) {
    set_has_is_site();
    data_.is_site_ = is_site;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
}
inline ::protocol::mediaproxy::v1::SiteMetadata* FetchLinkMetadataResponse::_internal_mutable_is_site() {
  if (!_internal_has_is_site()) {
    clear_data();
    set_has_is_site();
    data_.is_site_ = CreateMaybeMessage< ::protocol::mediaproxy::v1::SiteMetadata >(GetArena());
  }
  return data_.is_site_;
}
inline ::protocol::mediaproxy::v1::SiteMetadata* FetchLinkMetadataResponse::mutable_is_site() {
  // @@protoc_insertion_point(field_mutable:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
  return _internal_mutable_is_site();
}

// .protocol.mediaproxy.v1.MediaMetadata is_media = 2;
inline bool FetchLinkMetadataResponse::_internal_has_is_media() const {
  return data_case() == kIsMedia;
}
inline bool FetchLinkMetadataResponse::has_is_media() const {
  return _internal_has_is_media();
}
inline void FetchLinkMetadataResponse::set_has_is_media() {
  _oneof_case_[0] = kIsMedia;
}
inline void FetchLinkMetadataResponse::clear_is_media() {
...
inline ::protocol::mediaproxy::v1::MediaMetadata* FetchLinkMetadataResponse::release_is_media() {
  // @@protoc_insertion_point(field_release:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
  if (_internal_has_is_media()) {
    clear_has_data();
      ::protocol::mediaproxy::v1::MediaMetadata* temp = data_.is_media_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.is_media_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::protocol::mediaproxy::v1::MediaMetadata& FetchLinkMetadataResponse::_internal_is_media() const {
  return _internal_has_is_media()
      ? *data_.is_media_
      : *reinterpret_cast< ::protocol::mediaproxy::v1::MediaMetadata*>(&::protocol::mediaproxy::v1::_MediaMetadata_default_instance_);
}
inline const ::protocol::mediaproxy::v1::MediaMetadata& FetchLinkMetadataResponse::is_media() const {
  // @@protoc_insertion_point(field_get:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
  return _internal_is_media();
}
inline ::protocol::mediaproxy::v1::MediaMetadata* FetchLinkMetadataResponse::unsafe_arena_release_is_media() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
  if (_internal_has_is_media()) {
    clear_has_data();
    ::protocol::mediaproxy::v1::MediaMetadata* temp = data_.is_media_;
    data_.is_media_ = nullptr;
...
inline void FetchLinkMetadataResponse::unsafe_arena_set_allocated_is_media(::protocol::mediaproxy::v1::MediaMetadata* is_media) {
  clear_data();
  if (is_media) {
    set_has_is_media();
    data_.is_media_ = is_media;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
}
inline ::protocol::mediaproxy::v1::MediaMetadata* FetchLinkMetadataResponse::_internal_mutable_is_media() {
  if (!_internal_has_is_media()) {
    clear_data();
    set_has_is_media();
    data_.is_media_ = CreateMaybeMessage< ::protocol::mediaproxy::v1::MediaMetadata >(GetArena());
  }
  return data_.is_media_;
}
inline ::protocol::mediaproxy::v1::MediaMetadata* FetchLinkMetadataResponse::mutable_is_media() {
  // @@protoc_insertion_point(field_mutable:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
  return _internal_mutable_is_media();
}

inline bool FetchLinkMetadataResponse::has_data() const {
  return data_case() != DATA_NOT_SET;
}
inline void FetchLinkMetadataResponse::clear_has_data() {
  _oneof_case_[0] = DATA_NOT_SET;
}
inline FetchLinkMetadataResponse::DataCase FetchLinkMetadataResponse::data_case() const {
  return FetchLinkMetadataResponse::DataCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
