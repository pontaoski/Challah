...
extern PROTOBUF_INTERNAL_EXPORT_mediaproxy_2fv1_2fmediaproxy_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto;
...
class MediaMetadataDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MediaMetadata> _instance;
...
class FetchLinkMetadataResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<FetchLinkMetadataResponse> _instance;
  const ::protocol::mediaproxy::v1::SiteMetadata* is_site_;
  const ::protocol::mediaproxy::v1::MediaMetadata* is_media_;
} _FetchLinkMetadataResponse_default_instance_;
...
static void InitDefaultsscc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::protocol::mediaproxy::v1::_FetchLinkMetadataResponse_default_instance_;
    new (ptr) ::protocol::mediaproxy::v1::FetchLinkMetadataResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::protocol::mediaproxy::v1::FetchLinkMetadataResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto}, {
      &scc_info_SiteMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto.base,
      &scc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto.base,}};
...
static void InitDefaultsscc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::protocol::mediaproxy::v1::_MediaMetadata_default_instance_;
    new (ptr) ::protocol::mediaproxy::v1::MediaMetadata();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::protocol::mediaproxy::v1::MediaMetadata::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_mediaproxy_2fv1_2fmediaproxy_2eproto[7];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediaproxy_2fv1_2fmediaproxy_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::MediaMetadata, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::MediaMetadata, mimetype_),
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::MediaMetadata, filename_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::FetchLinkMetadataResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::FetchLinkMetadataResponse, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  offsetof(::protocol::mediaproxy::v1::FetchLinkMetadataResponseDefaultTypeInternal, is_site_),
  offsetof(::protocol::mediaproxy::v1::FetchLinkMetadataResponseDefaultTypeInternal, is_media_),
  PROTOBUF_FIELD_OFFSET(::protocol::mediaproxy::v1::FetchLinkMetadataResponse, data_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, sizeof(::protocol::mediaproxy::v1::MediaMetadata)},
  { 18, -1, sizeof(::protocol::mediaproxy::v1::FetchLinkMetadataRequest)},
  { 24, -1, sizeof(::protocol::mediaproxy::v1::FetchLinkMetadataResponse)},
  { 32, -1, sizeof(::protocol::mediaproxy::v1::InstantViewRequest)},
  { 38, -1, sizeof(::protocol::mediaproxy::v1::InstantViewResponse)},
  { 46, -1, sizeof(::protocol::mediaproxy::v1::CanInstantViewResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protocol::mediaproxy::v1::_MediaMetadata_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protocol::mediaproxy::v1::_FetchLinkMetadataRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protocol::mediaproxy::v1::_FetchLinkMetadataResponse_default_instance_),
...
const char descriptor_table_protodef_mediaproxy_2fv1_2fmediaproxy_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \001(\t\"3\n\rMediaMetadata\022\020\n\010mimetype\030\001 \001(\t\022"
  "\020\n\010filename\030\002 \001(\t\"\'\n\030FetchLinkMetadataRe"
  "quest\022\013\n\003url\030\001 \001(\t\"\227\001\n\031FetchLinkMetadata"
  "Response\0227\n\007is_site\030\001 \001(\0132$.protocol.med"
  "iaproxy.v1.SiteMetadataH\000\0229\n\010is_media\030\002 "
  "\001(\0132%.protocol.mediaproxy.v1.MediaMetada"
  "taH\000B\006\n\004data\"!\n\022InstantViewRequest\022\013\n\003ur"
  "l\030\001 \001(\t\"p\n\023InstantViewResponse\0226\n\010metada"
  "ta\030\001 \001(\0132$.protocol.mediaproxy.v1.SiteMe"
  "tadata\022\017\n\007content\030\002 \001(\t\022\020\n\010is_valid\030\003 \001("
  "\010\"2\n\026CanInstantViewResponse\022\030\n\020can_insta"
  "nt_view\030\001 \001(\0102\370\002\n\021MediaProxyService\022\177\n\021F"
  "etchLinkMetadata\0220.protocol.mediaproxy.v"
  "1.FetchLinkMetadataRequest\0321.protocol.me"
  "diaproxy.v1.FetchLinkMetadataResponse\"\005\232"
  "D\002\010\001\022m\n\013InstantView\022*.protocol.mediaprox"
  "y.v1.InstantViewRequest\032+.protocol.media"
  "proxy.v1.InstantViewResponse\"\005\232D\002\010\001\022s\n\016C"
  "anInstantView\022*.protocol.mediaproxy.v1.I"
  "nstantViewRequest\032..protocol.mediaproxy."
  "v1.CanInstantViewResponse\"\005\232D\002\010\001B9Z7gith"
  "ub.com/harmony-development/legato/gen/me"
  "diaproxy/v1b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_mediaproxy_2fv1_2fmediaproxy_2eproto_sccs[7] = {
  ...
  &scc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediaproxy_2fv1_2fmediaproxy_2eproto = {
  false, false, descriptor_table_protodef_mediaproxy_2fv1_2fmediaproxy_2eproto, "mediaproxy/v1/mediaproxy.proto", 1099,
  &descriptor_table_mediaproxy_2fv1_2fmediaproxy_2eproto_once, descriptor_table_mediaproxy_2fv1_2fmediaproxy_2eproto_sccs, descriptor_table_mediaproxy_2fv1_2fmediaproxy_2eproto_deps, 7, 1,
  schemas, file_default_instances, TableStruct_mediaproxy_2fv1_2fmediaproxy_2eproto::offsets,
  file_level_metadata_mediaproxy_2fv1_2fmediaproxy_2eproto, 7, file_level_enum_descriptors_mediaproxy_2fv1_2fmediaproxy_2eproto, file_level_service_descriptors_mediaproxy_2fv1_2fmediaproxy_2eproto,
};
...
void MediaMetadata::InitAsDefaultInstance() {
}
class MediaMetadata::_Internal {
 public:
};

MediaMetadata::MediaMetadata(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:protocol.mediaproxy.v1.MediaMetadata)
}
MediaMetadata::MediaMetadata(const MediaMetadata& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:protocol.mediaproxy.v1.MediaMetadata)
}

void MediaMetadata::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto.base);
  mimetype_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  filename_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

MediaMetadata::~MediaMetadata() {
  // @@protoc_insertion_point(destructor:protocol.mediaproxy.v1.MediaMetadata)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void MediaMetadata::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  mimetype_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  filename_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void MediaMetadata::ArenaDtor(void* object) {
  MediaMetadata* _this = reinterpret_cast< MediaMetadata* >(object);
  (void)_this;
}
void MediaMetadata::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void MediaMetadata::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const MediaMetadata& MediaMetadata::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_MediaMetadata_mediaproxy_2fv1_2fmediaproxy_2eproto.base);
  return *internal_default_instance();
}
...
// @@protoc_insertion_point(message_clear_start:protocol.mediaproxy.v1.MediaMetadata)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* MediaMetadata::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "protocol.mediaproxy.v1.MediaMetadata.mimetype"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string filename = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "protocol.mediaproxy.v1.MediaMetadata.filename"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* MediaMetadata::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:protocol.mediaproxy.v1.MediaMetadata)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->mimetype().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "protocol.mediaproxy.v1.MediaMetadata.mimetype");
    target = stream->WriteStringMaybeAliased(
  ...
  if (this->filename().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "protocol.mediaproxy.v1.MediaMetadata.filename");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protocol.mediaproxy.v1.MediaMetadata)
  return target;
}

size_t MediaMetadata::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protocol.mediaproxy.v1.MediaMetadata)
  size_t total_size = 0;
...
void MediaMetadata::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:protocol.mediaproxy.v1.MediaMetadata)
  GOOGLE_DCHECK_NE(&from, this);
  const MediaMetadata* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MediaMetadata>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:protocol.mediaproxy.v1.MediaMetadata)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:protocol.mediaproxy.v1.MediaMetadata)
    MergeFrom(*source);
  }
}

void MediaMetadata::MergeFrom(const MediaMetadata& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:protocol.mediaproxy.v1.MediaMetadata)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void MediaMetadata::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:protocol.mediaproxy.v1.MediaMetadata)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MediaMetadata::CopyFrom(const MediaMetadata& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:protocol.mediaproxy.v1.MediaMetadata)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MediaMetadata::IsInitialized() const {
  return true;
}

void MediaMetadata::InternalSwap(MediaMetadata* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata MediaMetadata::GetMetadata() const {
  return GetMetadataStatic();
}
...
void FetchLinkMetadataResponse::InitAsDefaultInstance() {
  ::protocol::mediaproxy::v1::_FetchLinkMetadataResponse_default_instance_.is_site_ = const_cast< ::protocol::mediaproxy::v1::SiteMetadata*>(
      ::protocol::mediaproxy::v1::SiteMetadata::internal_default_instance());
  ::protocol::mediaproxy::v1::_FetchLinkMetadataResponse_default_instance_.is_media_ = const_cast< ::protocol::mediaproxy::v1::MediaMetadata*>(
      ::protocol::mediaproxy::v1::MediaMetadata::internal_default_instance());
}
class FetchLinkMetadataResponse::_Internal {
 public:
  static const ::protocol::mediaproxy::v1::SiteMetadata& is_site(const FetchLinkMetadataResponse* msg);
  static const ::protocol::mediaproxy::v1::MediaMetadata& is_media(const FetchLinkMetadataResponse* msg);
};

const ::protocol::mediaproxy::v1::SiteMetadata&
FetchLinkMetadataResponse::_Internal::is_site(const FetchLinkMetadataResponse* msg) {
  return *msg->data_.is_site_;
}
const ::protocol::mediaproxy::v1::MediaMetadata&
FetchLinkMetadataResponse::_Internal::is_media(const FetchLinkMetadataResponse* msg) {
  return *msg->data_.is_media_;
}
void FetchLinkMetadataResponse::set_allocated_is_site(::protocol::mediaproxy::v1::SiteMetadata* is_site) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  clear_data();
  if (is_site) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(is_site);
    if (message_arena != submessage_arena) {
      is_site = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, is_site, submessage_arena);
    }
    set_has_is_site();
    data_.is_site_ = is_site;
  }
  // @@protoc_insertion_point(field_set_allocated:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_site)
}
void FetchLinkMetadataResponse::set_allocated_is_media(::protocol::mediaproxy::v1::MediaMetadata* is_media) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  clear_data();
  if (is_media) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(is_media);
    if (message_arena != submessage_arena) {
      is_media = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, is_media, submessage_arena);
    }
    set_has_is_media();
    data_.is_media_ = is_media;
  }
  // @@protoc_insertion_point(field_set_allocated:protocol.mediaproxy.v1.FetchLinkMetadataResponse.is_media)
}
FetchLinkMetadataResponse::FetchLinkMetadataResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
}
FetchLinkMetadataResponse::FetchLinkMetadataResponse(const FetchLinkMetadataResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  clear_has_data();
  switch (from.data_case()) {
    case kIsSite: {
      _internal_mutable_is_site()->::protocol::mediaproxy::v1::SiteMetadata::MergeFrom(from._internal_is_site());
      break;
    }
    case kIsMedia: {
      _internal_mutable_is_media()->::protocol::mediaproxy::v1::MediaMetadata::MergeFrom(from._internal_is_media());
      break;
    }
    case DATA_NOT_SET: {
      break;
  ...
  // @@protoc_insertion_point(copy_constructor:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
}

void FetchLinkMetadataResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto.base);
  clear_has_data();
}

FetchLinkMetadataResponse::~FetchLinkMetadataResponse() {
  // @@protoc_insertion_point(destructor:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void FetchLinkMetadataResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (has_data()) {
    clear_data();
  }
...
void FetchLinkMetadataResponse::ArenaDtor(void* object) {
  FetchLinkMetadataResponse* _this = reinterpret_cast< FetchLinkMetadataResponse* >(object);
  (void)_this;
}
void FetchLinkMetadataResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void FetchLinkMetadataResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const FetchLinkMetadataResponse& FetchLinkMetadataResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_FetchLinkMetadataResponse_mediaproxy_2fv1_2fmediaproxy_2eproto.base);
  return *internal_default_instance();
}


void FetchLinkMetadataResponse::clear_data() {
// @@protoc_insertion_point(one_of_clear_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  switch (data_case()) {
    case kIsSite: {
      if (GetArena() == nullptr) {
        delete data_.is_site_;
      }
      break;
    }
    case kIsMedia: {
      if (GetArena() == nullptr) {
        delete data_.is_media_;
      }
      break;
    }
    case DATA_NOT_SET: {
...
void FetchLinkMetadataResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* FetchLinkMetadataResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // .protocol.mediaproxy.v1.SiteMetadata is_site = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_is_site(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // .protocol.mediaproxy.v1.MediaMetadata is_media = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_is_media(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* FetchLinkMetadataResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;

  // .protocol.mediaproxy.v1.SiteMetadata is_site = 1;
  if (_internal_has_is_site()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        1, _Internal::is_site(this), target, stream);
  }

  // .protocol.mediaproxy.v1.MediaMetadata is_media = 2;
  if (_internal_has_is_media()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        2, _Internal::is_media(this), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  return target;
}

size_t FetchLinkMetadataResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  size_t total_size = 0;
...
void FetchLinkMetadataResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const FetchLinkMetadataResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<FetchLinkMetadataResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
    MergeFrom(*source);
  }
}

void FetchLinkMetadataResponse::MergeFrom(const FetchLinkMetadataResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void FetchLinkMetadataResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void FetchLinkMetadataResponse::CopyFrom(const FetchLinkMetadataResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:protocol.mediaproxy.v1.FetchLinkMetadataResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool FetchLinkMetadataResponse::IsInitialized() const {
  return true;
}

void FetchLinkMetadataResponse::InternalSwap(FetchLinkMetadataResponse* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata FetchLinkMetadataResponse::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::protocol::mediaproxy::v1::MediaMetadata* Arena::CreateMaybeMessage< ::protocol::mediaproxy::v1::MediaMetadata >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protocol::mediaproxy::v1::MediaMetadata >(arena);
}
...
template<> PROTOBUF_NOINLINE ::protocol::mediaproxy::v1::FetchLinkMetadataResponse* Arena::CreateMaybeMessage< ::protocol::mediaproxy::v1::FetchLinkMetadataResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protocol::mediaproxy::v1::FetchLinkMetadataResponse >(arena);
}
